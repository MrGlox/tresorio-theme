...
return [
    ...
    'composers' => [
        App\Composers\Blindfold::class,
        App\Composers\CardCallToAction::class,
        App\Composers\CallToAction::class,
        App\Composers\Footer::class,
        App\Composers\Header::class,
        App\Composers\Hero::class,
        App\Composers\Intro::class,
        App\Composers\Map::class,
        App\Composers\Navigation::class,
        App\Composers\Page404::class,
        App\Composers\ThemeOptions::class,
    ],
